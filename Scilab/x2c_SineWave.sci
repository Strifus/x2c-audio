...
function [x_sci,y_sci,typ_sci] = x2c_SineWave(job, arg1, arg2)

thisBlockData.Library = "Audio"
thisBlockData.block_type_name = "SineWave"
thisBlockData.block_xcosfilename = "x2c_SineWave"
...
case "set" then
    ...
    while %t do
        ...
        block_model.sim = list("x2c_SineWave_"  + impl + "_C", 4);
...
case "define" then
    ...
    model = scicos_model();
    impl = jinvoke(x2cPEdit, "getUsedImplementationName");
    model.sim = list("x2c_SineWave_"  + impl + "_C", 4);
