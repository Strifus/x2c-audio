...
/* */
void x2c_SineWave_FiP16_C(scicos_block* block, scicos_flag flag);
static void x2c_SineWave_FiP16_C__OutputUpdate(scicos_block* block);
static void x2c_SineWave_FiP16_C__StateUpdate(scicos_block* block);
static void x2c_SineWave_FiP16_C__Initialization(scicos_block* block);
static void x2c_SineWave_FiP16_C__Ending(scicos_block* block);
...
void x2c_SineWave_FiP16_C(scicos_block* block, scicos_flag flag) {
    ...
    switch (flag) {
        ...
        case OutputUpdate:     /* 1 */
        {
            x2c_SineWave_FiP16_C__OutputUpdate(block);
            break;
        }
        case StateUpdate:      /* 2 */
        {
            x2c_SineWave_FiP16_C__StateUpdate(block);
            break;
        }
        ...
        {
            x2c_SineWave_FiP16_C__Initialization(block);
            break;
        }
        case Ending:           /* 5 */
        {
            x2c_SineWave_FiP16_C__Ending(block);
            break;
        }
...
static void x2c_SineWave_FiP16_C__set_parameter(scicos_block* block, SINEWAVE_FIP16 *blockParam) {
    int *paramI;
    double *paramR;
    SINEWAVE_FIP16 *pTSineWave_FiP16;
    
    /* *** */
    paramI = GetIparPtrs(block);  /* integer parameters  */
    paramR = GetRparPtrs(block);  /* real parameters     */
    pTSineWave_FiP16 = GetWorkPtrs(block);
...
static void x2c_SineWave_FiP16_C__Initialization(scicos_block* block) {
    ...
    /* *** */
    pTSineWave_FiP16 = scicos_malloc(sizeof(SINEWAVE_FIP16));
    GetWorkPtrs(block) = pTSineWave_FiP16;
    x2c_SineWave_FiP16_C__set_parameter(block, pTSineWave_FiP16);
    ...
    /* Initialization */
    SineWave_FiP16_Init(pTSineWave_FiP16);

    /* Assignment of outports */
    outport_u = GetOutPortPtrs(block, 1);
    *outport_u = convert_Q15_to_double(pTSineWave_FiP16->u);
}
...
static void x2c_SineWave_FiP16_C__Ending(scicos_block* block) {
    SINEWAVE_FIP16 *pTSineWave_FiP16;
    pTSineWave_FiP16 = GetWorkPtrs(block);
    scicos_free(pTSineWave_FiP16);
}


static void x2c_SineWave_FiP16_C__StateUpdate_f(scicos_block* block) {
...
static void x2c_SineWave_FiP16_C__StateUpdate(scicos_block* block) {
    if (GetNevIn(block) > 0) {
        ...
        */
        x2c_SineWave_FiP16_C__StateUpdate_f(block);
    }
}
...
static void x2c_SineWave_FiP16_C__OutputUpdate(scicos_block* block) {
    ...
    /* Update */
    SineWave_FiP16_Update(pTSineWave_FiP16);
