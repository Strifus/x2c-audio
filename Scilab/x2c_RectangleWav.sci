// This file was generated by createIFunction.sci on 06-01-2020 12:06

function [x_sci,y_sci,typ_sci] = x2c_RectangleWav(job, arg1, arg2)

thisBlockData.Library = "Audio"
thisBlockData.block_type_name = "RectangleWave"
thisBlockData.block_xcosfilename = "x2c_RectangleWav"
...
case "set" then
    ...
    while %t do
        ...
        block_model.sim = list("x2c_RectangleWav_"  + impl + "_C", 4);
...
case "define" then
    ...
    model = scicos_model();
    impl = jinvoke(x2cPEdit, "getUsedImplementationName");
    model.sim = list("x2c_RectangleWav_"  + impl + "_C", 4);
