...
/* */
void x2c_TriangleWave_FiP8_C(scicos_block* block, scicos_flag flag);
static void x2c_TriangleWave_FiP8_C__OutputUpdate(scicos_block* block);
static void x2c_TriangleWave_FiP8_C__StateUpdate(scicos_block* block);
static void x2c_TriangleWave_FiP8_C__Initialization(scicos_block* block);
static void x2c_TriangleWave_FiP8_C__Ending(scicos_block* block);
...
void x2c_TriangleWave_FiP8_C(scicos_block* block, scicos_flag flag) {
    ...
    switch (flag) {
        ...
        case OutputUpdate:     /* 1 */
        {
            x2c_TriangleWave_FiP8_C__OutputUpdate(block);
            break;
        }
        case StateUpdate:      /* 2 */
        {
            x2c_TriangleWave_FiP8_C__StateUpdate(block);
            break;
        }
        ...
        {
            x2c_TriangleWave_FiP8_C__Initialization(block);
            break;
        }
        case Ending:           /* 5 */
        {
            x2c_TriangleWave_FiP8_C__Ending(block);
            break;
        }
...
static void x2c_TriangleWave_FiP8_C__set_parameter(scicos_block* block, TRIANGLEWAVE_FIP8 *blockParam) {
    int *paramI;
    double *paramR;
    TRIANGLEWAVE_FIP8 *pTTriangleWave_FiP8;
    
    /* *** */
    paramI = GetIparPtrs(block);  /* integer parameters  */
    paramR = GetRparPtrs(block);  /* real parameters     */
    pTTriangleWave_FiP8 = GetWorkPtrs(block);
...
static void x2c_TriangleWave_FiP8_C__Initialization(scicos_block* block) {
    ...
    /* *** */
    pTTriangleWave_FiP8 = scicos_malloc(sizeof(TRIANGLEWAVE_FIP8));
    GetWorkPtrs(block) = pTTriangleWave_FiP8;
    x2c_TriangleWave_FiP8_C__set_parameter(block, pTTriangleWave_FiP8);
    ...
    /* Initialization */
    TriangleWave_FiP8_Init(pTTriangleWave_FiP8);

    /* Assignment of outports */
    outport_u = GetOutPortPtrs(block, 1);
    *outport_u = convert_Q7_to_double(pTTriangleWave_FiP8->u);
}
...
static void x2c_TriangleWave_FiP8_C__Ending(scicos_block* block) {
    TRIANGLEWAVE_FIP8 *pTTriangleWave_FiP8;
    pTTriangleWave_FiP8 = GetWorkPtrs(block);
    scicos_free(pTTriangleWave_FiP8);
}


static void x2c_TriangleWave_FiP8_C__StateUpdate_f(scicos_block* block) {
...
static void x2c_TriangleWave_FiP8_C__StateUpdate(scicos_block* block) {
    if (GetNevIn(block) > 0) {
        ...
        */
        x2c_TriangleWave_FiP8_C__StateUpdate_f(block);
    }
}
...
static void x2c_TriangleWave_FiP8_C__OutputUpdate(scicos_block* block) {
    ...
    /* Update */
    TriangleWave_FiP8_Update(pTTriangleWave_FiP8);
