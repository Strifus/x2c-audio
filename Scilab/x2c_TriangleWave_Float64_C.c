...
#include <TriangleWave_Float64.c>
...
/* */
void x2c_TriangleWave_Float64_C(scicos_block* block, scicos_flag flag);
static void x2c_TriangleWave_Float64_C__OutputUpdate(scicos_block* block);
static void x2c_TriangleWave_Float64_C__StateUpdate(scicos_block* block);
static void x2c_TriangleWave_Float64_C__Initialization(scicos_block* block);
static void x2c_TriangleWave_Float64_C__Ending(scicos_block* block);
...
void x2c_TriangleWave_Float64_C(scicos_block* block, scicos_flag flag) {
    ...
    switch (flag) {
        ...
        case OutputUpdate:     /* 1 */
        {
            x2c_TriangleWave_Float64_C__OutputUpdate(block);
            break;
        }
        case StateUpdate:      /* 2 */
        {
            x2c_TriangleWave_Float64_C__StateUpdate(block);
            break;
        }
        ...
        {
            x2c_TriangleWave_Float64_C__Initialization(block);
            break;
        }
        case Ending:           /* 5 */
        {
            x2c_TriangleWave_Float64_C__Ending(block);
            break;
        }
...
static void x2c_TriangleWave_Float64_C__set_parameter(scicos_block* block, TRIANGLEWAVE_FLOAT64 *blockParam) {
    int *paramI;
    double *paramR;
    TRIANGLEWAVE_FLOAT64 *pTTriangleWave_Float64;
    
    /* *** */
    paramI = GetIparPtrs(block);  /* integer parameters  */
    paramR = GetRparPtrs(block);  /* real parameters     */
    pTTriangleWave_Float64 = GetWorkPtrs(block);
...
static void x2c_TriangleWave_Float64_C__Initialization(scicos_block* block) {
    ...
    /* *** */
    pTTriangleWave_Float64 = scicos_malloc(sizeof(TRIANGLEWAVE_FLOAT64));
    GetWorkPtrs(block) = pTTriangleWave_Float64;
    x2c_TriangleWave_Float64_C__set_parameter(block, pTTriangleWave_Float64);
    ...
    /* Initialization */
    TriangleWave_Float64_Init(pTTriangleWave_Float64);

    /* Assignment of outports */
    outport_u = GetOutPortPtrs(block, 1);
    *outport_u = convert_float64_to_double(pTTriangleWave_Float64->u);
}
...
static void x2c_TriangleWave_Float64_C__Ending(scicos_block* block) {
    TRIANGLEWAVE_FLOAT64 *pTTriangleWave_Float64;
    pTTriangleWave_Float64 = GetWorkPtrs(block);
    scicos_free(pTTriangleWave_Float64);
}


static void x2c_TriangleWave_Float64_C__StateUpdate_f(scicos_block* block) {
...
static void x2c_TriangleWave_Float64_C__StateUpdate(scicos_block* block) {
    if (GetNevIn(block) > 0) {
        ...
        */
        x2c_TriangleWave_Float64_C__StateUpdate_f(block);
    }
}
...
static void x2c_TriangleWave_Float64_C__OutputUpdate(scicos_block* block) {
    ...
    /* Update */
    TriangleWave_Float64_Update(pTTriangleWave_Float64);
